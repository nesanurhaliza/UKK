...
<link rel="stylesheet" href="assets/plugins/fontawesome/css/all.min.css">
 <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-oBqDVmMz4fnFO9gyb2yKq7K+FVhMo1B8bQ+Xs3RkO+jB91DuN6t48OtnMec1Qg==">
...
{{--
    ...
    <div class="container">
        <h1>Penilaian</h1>
        <a href="examinations.create" class="btn btn-primary">Tambah Penilain</a> --}}
            ...
            <div class="container mt-50"  id="" >
                    <div class="card">
                        <div class="card-header py-3">
                            <h4 class="m-0 font-weight-bold" style="justify-content: center">kompetensi standar</h4>
                        </div>
                            <div class="card-body">
                                <div class="col-md-6">
                                </div>
    ...
    <div class="card-body p-3">
        <table class="table table-striped">
            ...
            <tr>
                ...
                <th>
                    @if ($item->assessor && $item->assessor->user)
                        {{ $item->assessor->user->name }}
                    @else
                        N/A
                    @endif
                </th>
                <th>
                    <a href="/examinations.create/{{ $item->id }}" class="btn btn-primary">Pilih</a>
                </th>
            </tr>
        @endforeach
