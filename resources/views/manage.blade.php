...
<div class="row mt-4">
    ...
    <div class="container mt-5">
        ...
        <ul class="nav nav-tabs" id="managementTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="assessors-tab" data-bs-toggle="tab" data-bs-target="#assessors" type="button" role="tab" aria-controls="assessors" aria-selected="false">
                    Assessors
                </button>
            </li>
            <li class="nav-item" role="presentation">
        ...
        <div class="tab-content mt-4" id="managementTabsContent">
            <!-- Users Table -->
            <div class="tab-pane fade show active" id="users" as="tabpanel" aria-labelledby="users-tab">
                <h2>Users</h2>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/manage/delete/{{ $item->id}}"><button class="btn btn-danger btn-sm">Hapus</button></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
            ...
            <!-- Assessors Table -->
            <div class="tab-pane fade" id="assessors" as="tabpanel" aria-labelledby="assessors-tab">
                <h2>Assessors</h2>
                <table class="table table-striped">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $assessor->user->fullname}}</td>
                            <td>
                                <a href="/edit/{{ $assessor->id }}" class="btn btn-warning btn-sm">Edit</a>
            ...
            <!-- Students Table -->
            <div class="tab-pane fade" id="students" as="tabpanel" aria-labelledby="students-tab">
                <h2>Students</h2>
                <table class="table table-striped">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $student->id }}</td> <!-- Menampilkan nama user -->
                            <td>{{ $student->nisn }}</td> <!-- Menampilkan NISN -->
                            <td>{{ $student->grade_level }}</td> <!-- Menampilkan tingkat kelas -->
