                    ...
                    <ul>
                        <li class="submenu">
                            <a href="javascript:void(0);"><img src="assets/img/icons/product.svg"
                                    alt="img"><span> Admin</span> <span class="menu-arrow"></span></a>
                            <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"><img src="assets/img/icons/sales1.svg"
                                    alt="img"><span> Jurusan</span> <span class="menu-arrow"></span></a>
                            <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"><img src="assets/img/icons/users1.svg"
                                    alt="img"><span> Manajement Elemen Kompetensi</span> <span
            ...
            <div class="content">
                ...
                @section('content')
                    <div class="container">
                        ...
                        <form action="/manajement.createstandar" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="unit_title" id="unit_title" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="unit_deskripsi">Deskripsi</label>
                                <textarea name="unit_deskripsi" id="unit_deskripsi" class="form-control" required></textarea>
                            </div>
                            <div class="form-group">
