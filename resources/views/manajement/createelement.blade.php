...
<head>
    ...
    <title>Tambah Form Criteria</title>
...
<body>
    ...
    <div class="container mt-5">
        <form action="/manajement.createelement" method="POST" id="mainForm">
            @csrf

            <!-- Form container untuk menampung form-form dynamic -->
            ...
            <!-- Tombol untuk menambah form -->
            <button type="button" class="btn btn-secondary" id="addFormBtn">Tambah Form Criteria</button>

            <div class="form-group">
                <label for="competency_standard_id">Competency Standard</label>
                <select name="competency_standard_id" id="competency_standard_id" class="form-control" required>
                    <option value="">-- Pilih Competency Standard --</option>
    ...
    <script>
        document.getElementById('addFormBtn').addEventListener('click', function() {
            ...
            newForm.innerHTML = `
                <label for="criteria">Criteria</label>
                <input type="text" name="criteria[]" class="form-control" required>
                <button type="button" class="btn btn-danger removeFormBtn" onclick="removeForm(this)">Hapus</button>
            `;
        ...
        // Fungsi untuk menghapus form jika tombol Hapus diklik
